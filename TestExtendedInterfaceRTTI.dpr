...
{$IFDEF TESTING}
  try
    Soap.IntfInfo.GetIntfMetaData(InterfaceTypeInfo, IntfMD, fmoRTTIBaseMethods); // Compare with RTL version
  except
...
type
{$TYPEINFO ON} // Note: Needs to be on in XE6, probably before as well
